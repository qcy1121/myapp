...
import test.myapp.config.audit.AuditEventConverter;
import test.myapp.domain.PersistentAuditEvent;
...
import static test.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
