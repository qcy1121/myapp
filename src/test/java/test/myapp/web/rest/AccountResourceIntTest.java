...
import test.myapp.config.Constants;
import test.myapp.MyApp;
import test.myapp.domain.Authority;
import test.myapp.domain.User;
import test.myapp.repository.AuthorityRepository;
import test.myapp.repository.UserRepository;
import test.myapp.security.AuthoritiesConstants;
import test.myapp.service.MailService;
import test.myapp.service.dto.UserDTO;
import test.myapp.web.rest.errors.ExceptionTranslator;
import test.myapp.web.rest.vm.KeyAndPasswordVM;
import test.myapp.web.rest.vm.ManagedUserVM;
import test.myapp.service.UserService;
